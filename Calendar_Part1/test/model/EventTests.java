...
public class EventTests {
  ...
  public void addToCalendar() {
    ...
    assertEquals("- lab: 2025-01-06T14:00 to 2025-01-06T16:30", calendar.get(LocalDate.of(2025, 1, 6)).get(0).toString());
    assertEquals("- lab: 2025-01-08T14:00 to 2025-01-08T16:30", calendar.get(LocalDate.of(2025, 1, 8)).get(0).toString());
  }
